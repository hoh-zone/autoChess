            ...
            switch (_a.label) {
                case 0:
                    ...
                    res = tx.moveCall({
                        ...
                        arguments: [tx.object((0, sui_js_1.normalizeSuiObjectId)(constants_js_1.config.LINEUP_GLOBAL)), tx.object((0, sui_js_1.normalizeSuiObjectId)(constants_js_1.config.ROLE_GLOBAL))],
                    });
