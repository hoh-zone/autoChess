...
import { myHash0A, operationsA, stageAtom } from "../store/stages"
import useCheckout from "./transactions/CheckoutChess"
                          ...
                          >
                            <Stack gap={2}>
                              ...
                              <p className="text-slate-800">
                                {getLocale("Mode")}: {!nft.arena ? getLocale("free") : getLocale("arena")}
                              </p>
                              <p className="text-slate-800">
