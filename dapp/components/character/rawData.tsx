...
const roles_info: Roles = {
  assa1: { class: "assa1", level: 1, attack: 6, hp: 8, sp: 0, base_attack: 6, max_hp: 8, sp_cap: 3, effect_type: "skill", effect: "attack_lowest_hp", effect_value: "6" },
  assa1_1: { class: "assa1_1", level: 2, attack: 6, hp: 8, sp: 0, base_attack: 6, max_hp: 8, sp_cap: 3, effect_type: "skill", effect: "attack_lowest_hp", effect_value: "6" },
  assa2: { class: "assa2", level: 3, attack: 12, hp: 15, sp: 0, base_attack: 12, max_hp: 15, sp_cap: 2, effect_type: "skill", effect: "attack_lowest_hp", effect_value: "12" },
  assa2_1: { class: "assa2_1", level: 6, attack: 12, hp: 15, sp: 0, base_attack: 12, max_hp: 15, sp_cap: 2, effect_type: "skill", effect: "attack_lowest_hp", effect_value: "12" },
  assa3: { class: "assa3", level: 9, attack: 24, hp: 37, sp: 0, base_attack: 24, max_hp: 37, sp_cap: 1, effect_type: "skill", effect: "attack_lowest_hp", effect_value: "18" },

  cleric1: { class: "cleric1", level: 1, attack: 3, hp: 8, sp: 0, base_attack: 3, max_hp: 8, sp_cap: 3, effect_type: "skill", effect: "add_all_tmp_attack", effect_value: "1" },
  cleric1_1: { class: "cleric1_1", level: 2, attack: 3, hp: 8, sp: 0, base_attack: 3, max_hp: 8, sp_cap: 3, effect_type: "skill", effect: "add_all_tmp_attack", effect_value: "1" },
  cleric2: { class: "cleric2", level: 3, attack: 6, hp: 15, sp: 0, base_attack: 6, max_hp: 15, sp_cap: 2, effect_type: "skill", effect: "add_all_tmp_attack", effect_value: "2" },
  cleric2_1: { class: "cleric2_1", level: 6, attack: 6, hp: 15, sp: 0, base_attack: 6, max_hp: 15, sp_cap: 2, effect_type: "skill", effect: "add_all_tmp_attack", effect_value: "2" },
  cleric3: { class: "cleric3", level: 9, attack: 12, hp: 37, sp: 0, base_attack: 12, max_hp: 37, sp_cap: 1, effect_type: "skill", effect: "add_all_tmp_attack", effect_value: "4" },

  fighter1: { class: "fighter1", level: 1, attack: 4, hp: 9, sp: 0, base_attack: 4, max_hp: 9, sp_cap: 3, effect_type: "skill", effect: "reduce_all_tmp_attack", effect_value: "2" },
  fighter1_1: { class: "fighter1_1", level: 2, attack: 4, hp: 9, sp: 0, base_attack: 4, max_hp: 9, sp_cap: 3, effect_type: "skill", effect: "reduce_all_tmp_attack", effect_value: "2" },
  fighter2: { class: "fighter2", level: 3, attack: 12, hp: 18, sp: 0, base_attack: 12, max_hp: 18, sp_cap: 3, effect_type: "skill", effect: "reduce_all_tmp_attack", effect_value: "4" },
  ...
  tank2: { class: "tank2", level: 3, attack: 6, hp: 24, sp: 0, base_attack: 6, max_hp: 24, sp_cap: 3, effect_type: "skill", effect: "add_all_tmp_hp", effect_value: "4" },
  tank2_1: { class: "tank2_1", level: 6, attack: 6, hp: 24, sp: 0, base_attack: 6, max_hp: 24, sp_cap: 3, effect_type: "skill", effect: "add_all_tmp_hp", effect_value: "4" },
  tank3: { class: "tank3", level: 9, attack: 12, hp: 60, sp: 0, base_attack: 12, max_hp: 60, sp_cap: 2, effect_type: "skill", effect: "add_all_tmp_hp", effect_value: "8" },

  mega1: { class: "mega1", level: 1, attack: 4, hp: 11, sp: 0, base_attack: 4, max_hp: 11, sp_cap: 3, effect_type: "skill", effect: "aoe", effect_value: "4" },
  mega1_1: { class: "mega1_1", level: 2, attack: 4, hp: 11, sp: 0, base_attack: 4, max_hp: 11, sp_cap: 3, effect_type: "skill", effect: "aoe", effect_value: "4" },
  mega2: { class: "mega2", level: 3, attack: 8, hp: 21, sp: 0, base_attack: 8, max_hp: 21, sp_cap: 3, effect_type: "skill", effect: "aoe", effect_value: "8" },
  mega2_1: { class: "mega2_1", level: 6, attack: 8, hp: 21, sp: 0, base_attack: 8, max_hp: 21, sp_cap: 3, effect_type: "skill", effect: "aoe", effect_value: "8" },
  mega3: { class: "mega3", level: 9, attack: 16, hp: 50, sp: 0, base_attack: 16, max_hp: 50, sp_cap: 2, effect_type: "skill", effect: "aoe", effect_value: "16" },

  shaman1: { class: "shaman1", level: 1, attack: 5, hp: 9, sp: 0, base_attack: 5, max_hp: 9, sp_cap: 0, effect_type: "ring", effect: "forbid_debuff", effect_value: "" },
  shaman1_1: { class: "shaman1_1", level: 2, attack: 5, hp: 9, sp: 0, base_attack: 5, max_hp: 9, sp_cap: 0, effect_type: "ring", effect: "forbid_debuff", effect_value: "" },
  shaman2: { class: "shaman2", level: 3, attack: 10, hp: 21, sp: 0, base_attack: 10, max_hp: 21, sp_cap: 0, effect_type: "ring", effect: "forbid_debuff", effect_value: "" },
  ...
  slime2: { class: "slime2", level: 3, attack: 10, hp: 30, sp: 0, base_attack: 10, max_hp: 30, sp_cap: 0, effect_type: "ring", effect: "forbid_buff", effect_value: "6" },
  slime2_1: { class: "slime2_1", level: 6, attack: 10, hp: 30, sp: 0, base_attack: 10, max_hp: 30, sp_cap: 0, effect_type: "ring", effect: "forbid_buff", effect_value: "6" },
  slime3: { class: "slime3", level: 9, attack: 20, hp: 65, sp: 0, base_attack: 20, max_hp: 65, sp_cap: 0, effect_type: "ring", effect: "forbid_buff", effect_value: "10" },

  ani1: { class: "ani1", level: 1, attack: 4, hp: 12, sp: 0, base_attack: 4, max_hp: 12, sp_cap: 3, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "3" },
  ani1_1: { class: "ani1_1", level: 2, attack: 4, hp: 12, sp: 0, base_attack: 4, max_hp: 12, sp_cap: 3, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "3" },
  ani2: { class: "ani2", level: 3, attack: 8, hp: 24, sp: 0, base_attack: 8, max_hp: 24, sp_cap: 2, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "6" },
  ani2_1: { class: "ani2_1", level: 6, attack: 8, hp: 24, sp: 0, base_attack: 8, max_hp: 24, sp_cap: 2, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "6" },
  ani3: { class: "ani3", level: 9, attack: 16, hp: 60, sp: 0, base_attack: 16, max_hp: 60, sp_cap: 1, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "9" },

  tree1: { class: "tree1", level: 1, attack: 5, hp: 11, sp: 0, base_attack: 5, max_hp: 11, sp_cap: 3, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "3" },
  tree1_1: { class: "tree1_1", level: 2, attack: 5, hp: 11, sp: 0, base_attack: 5, max_hp: 11, sp_cap: 3, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "3" },
  tree2: { class: "tree2", level: 3, attack: 10, hp: 21, sp: 0, base_attack: 10, max_hp: 21, sp_cap: 2, effect_type: "skill", effect: "reduce_tmp_attack", effect_value: "6" },
  ...
  priest2: { class: "priest2", level: 3, attack: 6, hp: 24, sp: 0, base_attack: 6, max_hp: 24, sp_cap: 3, effect_type: "skill", effect: "all_max_hp_to_back1", effect_value: "8" },
  ...
  archer1: { class: "archer1", level: 1, attack: 6, hp: 9, sp: 0, base_attack: 6, max_hp: 9, sp_cap: 3, effect_type: "skill", effect: "attack_last_char", effect_value: "7" },
  archer1_1: { class: "archer1_1", level: 2, attack: 6, hp: 9, sp: 0, base_attack: 6, max_hp: 9, sp_cap: 3, effect_type: "skill", effect: "attack_last_char", effect_value: "7" },
  archer2: { class: "archer2", level: 3, attack: 12, hp: 18, sp: 0, base_attack: 12, max_hp: 18, sp_cap: 2, effect_type: "skill", effect: "attack_last_char", effect_value: "14" },
  archer2_1: { class: "archer2_1", level: 6, attack: 12, hp: 18, sp: 0, base_attack: 12, max_hp: 18, sp_cap: 2, effect_type: "skill", effect: "attack_last_char", effect_value: "14" },
  archer3: { class: "archer3", level: 9, attack: 24, hp: 45, sp: 0, base_attack: 24, max_hp: 45, sp_cap: 1, effect_type: "skill", effect: "attack_last_char", effect_value: "24" }
}
