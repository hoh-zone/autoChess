export const SKILL_DESCRIPTION: Record<string, string> = {
    ...
    "add_all_tmp_sp": "Add $value points of sp to all friendly units.",
    ...
    "add_all_tmp_sp_cap": "Increse the number of attacks to get full sp upon all enermies by $value times.",
