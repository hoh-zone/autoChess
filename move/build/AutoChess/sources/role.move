module auto_chess::role {
    ...
    public fun init_charactors1(global: &mut Global) {
        ...
        vec_map::insert(&mut global.charactors, utf8(b"fighter1"), Role {name:utf8(b"fighter1"), level: 1, price: 3, attack:  4, life: 6, magic: 0, max_magic: 1, effect_type: utf8(b"skill"), effect: utf8(b"reduce_all_tmp_attack"), effect_value: utf8(b"2")});
        ...
        vec_map::insert(&mut global.charactors, utf8(b"mega2_1"), Role {name:utf8(b"mega2_1"), level: 6, price: 8, attack:  8, life: 14, magic: 0, max_magic: 3, effect_type: utf8(b"skill"), effect: utf8(b"aoe"), effect_value: utf8(b"8")});
