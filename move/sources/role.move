module auto_chess::role {
    ...
    public fun init_charactos(global: &mut Global) {
        ...
        vec_map::insert(&mut global.charactors, utf8(b"assa1"), Role {name:utf8(b"assa1"), attack:7, life:4, level:1, magic: 1, price:3, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"assa1_1"), Role {name:utf8(b"assa1_1"), attack:7, life: 4, level:2, magic: 1, price:5, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"assa2"), Role {name:utf8(b"assa2"), attack:13, life:9, level:3, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"assa2_1"), Role {name:utf8(b"assa2_1"), attack:13, life:9, level:6, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"assa3"), Role {name:utf8(b"assa3"), attack:23, life:13, level:9, magic: 1, price:9, effect:utf8(b""), effect_value:utf8(b"")});
        ...
        vec_map::insert(&mut global.charactors, utf8(b"mega1"), Role {name:utf8(b"mega1"), attack:6, life:5, level:1, magic: 1, price:3, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"mega1_1"), Role {name:utf8(b"mega1_1"), attack:6, life:5, level:2, magic: 1, price:5, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"mega2"), Role {name:utf8(b"mega2"), attack:12, life:10, level:3, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"mega2_1"), Role {name:utf8(b"mega2_1"), attack:12, life:10, level:6, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"mega3"), Role {name:utf8(b"mega3"), attack:24, life:20, level:9, magic: 1, price:9, effect:utf8(b""), effect_value:utf8(b"")});
        
        vec_map::insert(&mut global.charactors, utf8(b"shaman1"), Role {name:utf8(b"shaman1"), attack:6, life:5, level:1, magic: 1, price:3, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"shaman1_1"), Role {name:utf8(b"shaman1_1"), attack:6, life:5, level:2, magic: 1, price:5, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"shaman2"), Role {name:utf8(b"shaman2"), attack:12, life:11, level:3, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"shaman2_1"), Role {name:utf8(b"shaman2_1"), attack:12, life:11, level:6, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"shaman3"), Role {name:utf8(b"shaman3"), attack:22, life:22, level:9, magic: 1, price:9, effect:utf8(b""), effect_value:utf8(b"")});
        ...
        vec_map::insert(&mut global.charactors, utf8(b"tree1"), Role {name:utf8(b"tree1"), attack:3, life:8, level:1, magic: 1, price:3, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"tree1_1"), Role {name:utf8(b"tree1_1"), attack:3, life:8, level:2, magic: 1, price:5, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"tree2"), Role {name:utf8(b"tree2"), attack:5, life:18, level:3, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"tree2_1"), Role {name:utf8(b"tree2_1"), attack:5, life:18, level:6, magic: 1, price:7, effect:utf8(b""), effect_value:utf8(b"")});
        vec_map::insert(&mut global.charactors, utf8(b"tree3"), Role {name:utf8(b"tree3"), attack:12, life:40, level:9, magic: 1, price:9, effect:utf8(b""), effect_value:utf8(b"")});
    }
