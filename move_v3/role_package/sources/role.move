...
vec_map::insert(&mut global.charactors, utf8(b"archer3"), Role {class:utf8(b"archer3"), level: 9, gold_cost: 10, attack:  24, hp: 45, speed: 12, sp:0, sp_cap: 1, effect_type: utf8(b"skill"), effect: utf8(b"attack_last_char"), effect_value: utf8(b"24")});
    ...
    public fun decrease_hp(role:&mut Role, decreased_value:u64) {
        role.hp = role.hp - decreased_value;
    }

    public fun increase_speed(role:&mut Role, increased_value:u64) {
        role.speed = role.speed + increased_value;
    }

    public fun increase_attack(role:&mut Role, increased_value:u64) {
        role.attack = role.attack + increased_value;
    }
