...
module role_package::role {
    ...
    public fun init_charactors1(global: &mut Global) {
        ...
        vec_map::insert(&mut global.charactors, utf8(b"fighter1"), Role {class:utf8(b"fighter1"), level: 1, gold_cost: 3, attack:  4, hp: 9, sp: 0, sp_cap: 3, effect_type: utf8(b"skill"), effect: utf8(b"reduce_all_tmp_attack"), effect_value: utf8(b"2")});
