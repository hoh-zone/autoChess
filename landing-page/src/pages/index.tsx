  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          id='home'
          initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: 'backOut' }}
        ...
        <a href="https://autochess.app" className='mt-16 mb-24'>
          <button >
            Enter Game 🕹️
          </button>
        </a>
        ...
        <motion.div
          initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5, duration: 1, ease: 'backOut' }}
          className="flex gap-16 md:flex-wrap lg:flex-nowrap mb-24">
          <div
            className="glass2 p-4"
          >
          ...
          >
            ...
            <p className={`m-0 max-w-[30ch] text-md  font-sans text-gray-800`}>
              Showcase your strategy in turn-based battles featuring Auto-Battler gameplay.
            </p>
          </div>
        ...
        <motion.div
          initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 1, ease: 'backOut' }}
          className='w-full'>
          <CharacterLine />
        </motion.div>
      </main>
